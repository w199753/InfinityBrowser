...
namespace Infinity.Graphics
{
    internal unsafe class Dx12TextureView : RHITextureView
    {
        ...
        public Dx12TextureView(Dx12Texture texture, in RHITextureViewCreateInfo createInfo)
        {
            ...
            else if (Dx12Utility.IsRenderTargetTexture(usages))
            {
        ...
        {
            ETextureUsageFlags usages = m_Dx12Texture.Usages;
            ...
            else if (Dx12Utility.IsShaderResourceTexture(usages) || Dx12Utility.IsUnorderedAccessTexture(usages))
            {
